...
export const useCateStore = defineStore('cate', () => {
    ...
    const cateExp = ref([
        {
            ...
            thumImg: '/assets/image/prod/thumImg/block_sample01.jpg',
            cateText: `
    ...
    const cateGroup = ref([
        ...
        // children: [
        {
            ...
            thumImg: '/assets/image/prod/thumImg/block_sample01.jpg',
            detailImg: '/assets/image/prod/samhwa1.jpg',
            exImg: [
                { example: '/assets/image/prod/thumImg/block_sample01.jpg' },
                { example: '/assets/image/prod/thumImg/block_sample01.jpg' },
                { example: '/assets/image/prod/thumImg/block_sample01.jpg' },
            ],
            tag:'도시적인', 
        ...
        },
        {
            ...
            thumImg: '/assets/image/prod/thumImg/block_sample02.jpg',
            detailImg: '/assets/image/prod/samhwa2.jpg',
            tag:'안정적인',
            sumText: `
        ...
        },
        {
            ...
            thumImg: '/assets/image/prod/thumImg/block_sample03.jpg',
            detailImg: '/assets/image/prod/samhwa3.jpg',
            tag:'잔디 식생이 유리한',
            sumText: `
                <p>시공이 뛰어나고 취급이 용이</p>
        ...
        },
        {
            ...
            thumImg: '/assets/image/prod/thumImg/block_sample04.jpg',
            detailImg: '/assets/image/prod/samhwa4.jpg',
            tag:'다목적 경계용',
            sumText: `
